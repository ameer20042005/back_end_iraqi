...
def test_environment_variables_do_not_override_static_settings(monkeypatch):
    ...
    assert settings.stt_model_for(Lang.AR).repository == "ayoubkirouane/whisper-small-ar"
    assert settings.tts_model_for(Lang.AR).repository == "ameer4wisam/Habibi-TTS-IRQ"
