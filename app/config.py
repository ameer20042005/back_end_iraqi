...
class Settings:
    ...
    # سقف عدد المنتجات المسموح حقنها بالبرومبت دفعة وحدة —
    # انظر app/context_blocks.py::catalog_context_block
    # وapp/tools/products.py. الكتالوج الكامل يتنافس على نفس ميزانية
    # max_model_len مع البرومبت
