...
منسوخة من مشروع iraqi_words_finetuning/rag — بعد أي تعديل على word.json هناك،
أعد التوليد بـ `python rag/prepare_rag.py` ثم انسخ documents.jsonl المحدّث إلى هنا.
"""
