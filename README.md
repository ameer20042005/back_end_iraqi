...
**خصوصية بيانات العملاء** (`app/features/support/router.py`): طلب بيانات الاتصال (هواتف/عناوين) والاستعلام الجماعي عن دفتر الطلبات بلا معرّف يخصّ المتحدث — كلاهما يُرفض حتمياً قبل الوصول للموديل. التغطية بـ `tests/test_support_privacy.py`.
